...
root=fileparts(mfilename('fullpath')); originalPath=path;
...
assert(report.automatic.failed==0 && report.automatic.incomplete==0,'rtsim:TestFailure','存在失败或未完成的自动测试，请查看 results/acceptance。');
end
