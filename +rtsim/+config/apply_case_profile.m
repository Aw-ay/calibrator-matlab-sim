function cfg = apply_case_profile(cfg, profileName)
    ...
    switch upper(char(profileName))
        ...
        case {'A1', 'CABLE'}
            cfg.channel.kind = 'CABLE';
            cfg.target.gain = 1;
        case {'B1', 'FLIGHT'}
            cfg.platform.velocity_mps = [10; 0; 0];
            cfg.platform.roll_deg = 8;
            cfg.navigation.delay_s = 0.5e-3;
            cfg.navigation.position_bias_m = [0.01; 0; 0];
            cfg.environment.ambient_C = 45;
            cfg.environment.body_rcs_m2 = 0.1;
