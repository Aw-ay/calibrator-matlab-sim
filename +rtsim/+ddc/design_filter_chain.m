...
requiredBw = {'coefficients','passband_Hz','stopband_Hz','max_passband_ripple_dB','min_stopband_attenuation_dB'};
...
H = fft(b, nfft); f = (0:nfft/2) * ratePlan.input_fs_Hz / nfft;
mag = abs(H(1:nfft/2+1)); magDb = 20*log10(max(mag, realmin));
