function [delivered, st, diag] = pdw_fifo_step(pdwInput, serviceEvents, st, cfgFifo)
    ...
    diag.queue_depth = numel(queue);
    diag.delivered_count = n;
