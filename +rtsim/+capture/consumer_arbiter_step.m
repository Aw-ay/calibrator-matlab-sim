function [grants, st, diag] = consumer_arbiter_step(requests, st, memoryPortModel)
    ...
    if ~isfield(st, 'pending')
        st.pending = struct('consumer', {}, 'bank_id', {}, 'bank_generation', {}, 'bytes', {}, 'sequence', {});
    end
